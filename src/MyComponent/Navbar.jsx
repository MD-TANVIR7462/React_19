    ...
    <nav className="bg-white ">
      <div className=" mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 ">
          <div className="flex items-center">
            <a href="#" className="flex-shrink-0 flex items-center">
              <span className="ml-2 text-xl font-bold text-gray-800">
                <span className="text-blue-400">Action</span> <span className="text-yellow-400 font-bold">Gallery</span>
              </span>
            </a>
          </div>
          {!isMobile && (
          ...
          <div>
            <div className="flex items-center justify-cente h-full gap-3.5">
              <div className="bg-blue-100 rounded-full p-3 inline-flex">
                <Bell className="text-blue-950 w-5 h-5" />
              </div>
